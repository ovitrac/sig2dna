...
- [🧠 4| **Entropy and Distance Metrics**](#entropy-and-distance-metrics)
- [🌀 5 | **Sinusoidal Encoding of Symbolic Segments**](#sinusoidal-encoding-of-symbolic-segments)
- [🔍 6| **Baseline Filtering and Poisson Noise Rejection**](#baseline-filtering-and-poisson-noise-rejection)
- [🧪 7| **Synthetic Signal Generation**](#synthetic-signal-generation)
- [📦 8| **Available Classes**](#available-classes)
- [📏  9| **Example Workflow**](#example-workflow)
- [📊 10| **Visualization**](#visualization)
- [🔎 11| **Motif Detection**](#motif-detection)
- [🤝 12| **Alignment**](#alignment)
- [🧪 13| **Examples** (unsorted)](#examples-unsorted)
